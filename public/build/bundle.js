...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			img = element("img");
    			attr_dev(img, "class", "opacity-0 transition-opacity duration-1000 ease-out svelte-j6m99u");
    			if (img.src !== (img_src_value = /*src*/ ctx[0])) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", /*alt*/ ctx[1]);
    			attr_dev(img, "loading", "lazy");
    			toggle_class(img, "loaded", /*loaded*/ ctx[2]);
    			add_location(img, file, 16, 0, 248);
    		},
    ...
    /* src/components/IntersectionObserver.svelte generated by Svelte v3.24.1 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 23, 0, 703);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (default_slot) {
    				if (default_slot.p && dirty & /*$$scope, intersecting*/ 130) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ["once", "bottom", "left", "top", "right"];
    ...
    /* src/Movie.svelte generated by Svelte v3.24.1 */

    // (14:4) {#if intersecting || nativeLoading}
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(14:4) {#if intersecting || nativeLoading}",
    		ctx
    	});
    ...
    // (13:0) <IntersectionObserver once={true} let:intersecting={intersecting}>
    function create_default_slot(ctx) {
    	let if_block_anchor;
    	let current;
    	let if_block = (/*intersecting*/ ctx[1] || /*nativeLoading*/ ctx[0]) && create_if_block(ctx);
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (/*intersecting*/ ctx[1] || /*nativeLoading*/ ctx[0]) {
    				if (if_block) {
    					if_block.p(ctx, dirty);

    					if (dirty & /*intersecting, nativeLoading*/ 3) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(13:0) <IntersectionObserver once={true} let:intersecting={intersecting}>",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$$scope, intersecting, nativeLoading*/ 7) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	onMount(() => {
    		if ("loading" in HTMLImageElement.prototype) {
    			$$invalidate(0, nativeLoading = true);
    		}
    	});
    	...
    	$$self.$inject_state = $$props => {
    		if ("nativeLoading" in $$props) $$invalidate(0, nativeLoading = $$props.nativeLoading);
    	};
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 69713, 1, 1530732);
    			add_location(h2, file$2, 69714, 1, 1530787);
    			attr_dev(a, "href", "https://svelte.dev/tutorial");
    			add_location(a, file$2, 69717, 2, 1530851);
    			attr_dev(p, "class", "bg-blue-300");
    			add_location(p, file$2, 69715, 1, 1530813);
    			add_location(main, file$2, 69712, 0, 1530724);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*lastName*/ 1) set_data_dev(t3, /*lastName*/ ctx[0]);
    			if (!current || dirty & /*age*/ 4) set_data_dev(t7, /*age*/ ctx[2]);
    		},
    		i: function intro(local) {
    			if (current) return;
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	let { name } = $$props;
    	let { age } = $$props;
    	const writable_props = ["lastName", "name", "age"];
    	...
    	$$self.$$set = $$props => {
    		if ("lastName" in $$props) $$invalidate(0, lastName = $$props.lastName);
    		if ("name" in $$props) $$invalidate(1, name = $$props.name);
    		if ("age" in $$props) $$invalidate(2, age = $$props.age);
    	};

    	$$self.$capture_state = () => ({ Movie, lastName, name, age });
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { lastName: 0, name: 1, age: 2 });
    		...
    		if (/*lastName*/ ctx[0] === undefined && !("lastName" in props)) {
